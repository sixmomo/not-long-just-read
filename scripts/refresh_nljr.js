...
const REGISTRY_PATH = path.join(ROOT, "ui", "data", "source-registry.json");
const LEDGER_PATH = path.join(ROOT, "ui", "data", "nljr-article-ledger.json");
const FEED_PATH = path.join(ROOT, "ui", "data", "nljr-feed.json");
