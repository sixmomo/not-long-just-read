...
- It sits inside the pillar: **AI Portfolio / Project Coaching**.
...
AI PM 作品集的 5 个组成部分：problem, user, solution, metrics, tradeoff。
...
Readers who save or comment on this pillar may need AI portfolio/project coaching.
