...
This draft is aligned with the account strategy because it connects a high-intent audience pain to the commercial wedge: AI portfolio / project coaching.
...
- Clear pain: candidates do not know what AI project to build or how to explain it.
- Strong save potential: the framework can become a reusable checklist.
...
- If the carousel becomes too text-heavy, split the framework across pages.
- The CTA should stay consultative, not salesy.

## Revision Suggestions

1. Add one concrete mini-example for BA, Ops, Consulting, or TPM.
2. Keep page 1 direct and high-anxiety.
3. Make one page explicitly interview-facing: how to present this project when challenged.
