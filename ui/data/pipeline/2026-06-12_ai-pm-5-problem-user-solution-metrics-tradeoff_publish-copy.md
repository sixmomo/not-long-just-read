...
1. AI PM 作品集的 5 个组成部分：problem, user, solution, metrics, tradeoff。
...
- Post: AI PM 作品集的 5 个组成部分：problem, user, solution, metrics, tradeoff。
- Pillar: AI Portfolio / Project Coaching
- Topic hypothesis: Readers who save or comment on this pillar may need AI portfolio/project coaching.
- Brief file: content_pipeline/drafts/2026-06-12_ai-pm-5-problem-user-solution-metrics-tradeoff_brief.md
